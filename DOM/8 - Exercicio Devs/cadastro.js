function createLabel (text, htmlFor) {  //funcao criada para criar uma label
...
function createInput(id,value,name,type = 'text', placeholder = '') { //Funcao criada para criar um input
